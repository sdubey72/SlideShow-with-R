...
\hlstd{drac_pos[}\hlnum{1}\hlopt{:}\hlnum{10}\hlstd{,]}
\end{alltt}
\begin{verbatim}
## # A tibble: 10 x 3
...
\hlstd{drac_neg[}\hlnum{1}\hlopt{:}\hlnum{10}\hlstd{,]}
\end{alltt}
\begin{verbatim}
## # A tibble: 10 x 3
##        word count sentiment
...
\hlstd{compPlot}\hlkwb{<-}\hlkwd{ggplot}\hlstd{()}\hlopt{+}
  \hlkwd{geom_bar}\hlstd{(}\hlkwc{data}\hlstd{=drac_compare,}\hlkwd{aes}\hlstd{(}\hlkwc{x}\hlstd{=word,}
                                 \hlkwc{y}\hlstd{=count,}
